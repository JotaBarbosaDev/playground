    ...
    return (
        <Pagination.Item
            ...
            className={({ isSelected }) =>
                cx(
                    "flex size-10 cursor-pointer items-center justify-center p-3 text-sm font-medium text-muted-foreground outline-focus-ring transition duration-100 ease-linear hover:bg-accent hover:text-foreground focus-visible:z-10 focus-visible:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2",
            ...
            <Pagination.Context>
                {({ pages, currentPage, total }) => (
                    <>
                        ...
                        <div className="flex justify-center text-sm whitespace-pre text-muted-foreground md:hidden">

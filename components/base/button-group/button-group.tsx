...
export const styles = sortCx({
    common: {
        root: [
            ...
            // Disabled styles
            "disabled:cursor-not-allowed disabled:bg-card disabled:text-disabled",
            // Selected styles
            "selected:bg-active selected:text-foreground selected:disabled:bg-disabled_subtle",
        ].join(" "),
        icon: "pointer-events-none text-muted-foreground transition-[inherit] group-hover/button-group:text-foreground group-disabled/button-group:text-fg-disabled_subtle",
    },

...
export const styles = sortCx({
    ...
    colors: {
        ...
        tertiary: {
            root: [
                "text-muted-foreground hover:bg-accent hover:text-foreground data-loading:bg-accent",
                // Icon styles
                "*:data-icon:text-muted-foreground hover:*:data-icon:text-foreground",
            ].join(" "),
        },
        ...
        "secondary-destructive": {
            root: [
                "bg-card text-error-primary shadow-xs-skeumorphic ring-1 ring-error_subtle outline-error ring-inset hover:bg-error-primary hover:text-error-primary_hover data-loading:bg-error-primary",
                // Disabled styles
                "disabled:bg-card disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles

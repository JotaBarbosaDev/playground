...
export const styles = {
    secondary:
        "bg-card text-muted-foreground shadow-xs-skeumorphic ring-1 ring-border ring-inset hover:bg-accent hover:text-foreground disabled:shadow-xs disabled:ring-disabled_subtle",
